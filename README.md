...
* <font color="red"> **Edit 27/09/2019**</font> : Small changes of the input data normalization and architecture. The new normalization of the SC functions should be between -1 and 1 (0 and 1 in the 1st version). The new autoencoder only has 4 hidden layers (6 layers in the first version). These two changes decrease the number of parameters to train for the same level of performance. <font color="red"> **A revised version of the pre-print will soon be online.**</font> 
